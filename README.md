...
[<img width="80%" title="Jenkins" src="media/img/Jenkins.PNG"/>]()
...
### *Main report page*
[<img width="80%" title="Main report page" src="media/img/Allure_main_report_page.PNG"/>](https://jenkins.autotests.cloud/job/027-wqmnzx-duolingo_diplom/allure/)

### *Test cases*
[<img width="80%" title="Test cases" src="media/img/Allure_test_cases.PNG"/>](https://jenkins.autotests.cloud/job/027-wqmnzx-duolingo_diplom/allure/#suites)

### *Graphs*
[<img width="80%" title="Graphs" src="media/img/Allure_graphs.PNG"/>](https://jenkins.autotests.cloud/job/027-wqmnzx-duolingo_diplom/allure/#graph)
...
[<img width="80%" title="Dashboard" src="media/img/Allure_TO_dashboards.PNG"/>](https://allure.autotests.cloud/project/4388/dashboards)

### *Launches*
This section displays test runs launched from Jenkins and Allure TestOps:
[<img width="80%" title="Launches" src="media/img/Allure_TO_launches.PNG"/>](https://allure.autotests.cloud/project/4388/launches)
...
### *Jira task*
[<img width="80%" title="Jira task" src="media/img/Jira_task.PNG"/>](https://jira.autotests.cloud/browse/HOMEWORK-1328)

### *Allure: Launches*
[<img width="80%" title="Allure: Test Cases" src="media/img/Jira_launches.PNG"/>](https://jira.autotests.cloud/browse/HOMEWORK-1328)
