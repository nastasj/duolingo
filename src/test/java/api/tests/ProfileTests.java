...
public class ProfileTests extends TestBase {
        ...
        SearchUsersResponseModel response =
                step("Send GET request to search for users", () ->
                        given(requestSpec)
                                ...
                                .when()
                                .get("2017-06-30/friends/users?pageSize=20&query=" +
                                        faker.name().firstName() + "&searchType=QUERY&_=1723549284611")
                                .then()
        ...
        ValidatableResponse response =
                step("Send GET request to search for users with no required query parameter", () ->
                        given(requestSpec)
                                .header("Authorization", authConfig.token())
                                .when()
                                .get("2017-06-30/friends/users?pageSize=20&searchType=QUERY&_=1723549284611")
                                .then()
        ...
        ValidatableResponse response =
                step("Send GET request to view user profile with invalid userId", () ->
                        given(requestSpec)
                                ...
                                .when()
                                .get("/2017-06-30/friends/users/"
                                        + faker.cat().name() + "/profile?pageSize=5&_=1723554223005")
                                .then()
    ...
    void subscribeToUserTest() {
        ...
        request.setFollow_reason("search");
